...
import { AlumniDirController } from '@/src/alumnidir/controller/AlumniDirController';
import AlumniDirView from '@/src/alumnidir/views/AlumniDirView';
...
const AlumniDirectoryPage: React.FC<AlumniPageProps> = ({ alumniData }) => {
    return (
        <AlumniDirController alumniData={alumniData}>
            <Head>
                <link rel="icon" href="/favicon.ico" type="image/ico" sizes="70x70" />
                <title>Alumni Directory | Vaishali Central School Alumni | Connect, Inspire, Grow</title>
                ...
                <meta property="og:url" content="https://vcs-alumni.vercel.app/alumni-directory" />
            ...
            <AlumniDirView alumniData={alumniData} />
        </AlumniDirController>
    );
};

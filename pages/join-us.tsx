            ...
            <div className='flex flex-col gap-16 w-full h-auto items-center justify-center py-20'>
                ...
                <div className='md:w-10/12 w-11/12 h-auto flex md:flex-row flex-col items-center justify-center gap-16'>
                    ...
                    <div className='md:w-1/2 w-full h-auto flex items-center justify-center'>
                        <Image src={'/connect/steps/step1.png'} alt='connect' width={550} height={550} priority={true} className='shadow border border-[#ebebeb] w-full h-96 object-cover rounded-md' />
                    </div>
                </div>
                ...
                <div className='md:w-10/12 w-11/12 h-auto flex md:flex-row-reverse flex-col items-center justify-center gap-16'>
                    ...
                    <div className='md:w-1/2 w-full h-auto flex items-center justify-center'>
                        <Image src={'/connect/steps/step2.png'} alt='connect' width={550} height={550} priority={true} className='shadow border border-[#ebebeb] w-full h-96 object-cover rounded-md' />
                    </div>
                </div>
                ...
                <div className='md:w-10/12 w-11/12 h-auto flex md:flex-row flex-col items-center justify-center gap-16'>
                    ...
                    <div className='md:w-1/2 w-full h-auto flex items-center justify-center'>
                        <Image src={'/connect/steps/step3.png'} alt='connect' width={550} height={550} priority={true} className='shadow border border-[#ebebeb] w-full h-96 object-cover rounded-md' />
                    </div>
                </div>
                ...
                <div className='md:w-10/12 w-11/12 h-auto flex md:flex-row-reverse flex-col items-center justify-center gap-16'>
                    ...
                    <div className='md:w-1/2 w-full h-auto flex items-center justify-center'>
                        <Image src={'/connect/steps/step4.png'} alt='connect' width={550} height={550} priority={true} className='shadow border border-[#ebebeb] w-full h-96 object-cover rounded-md' />
                    </div>
                </div>
                ...
                <div className='md:w-10/12 w-11/12 h-auto flex md:flex-row flex-col items-center justify-center gap-16'>
                    ...
                    <div className='md:w-1/2 w-full h-auto flex items-center justify-center'>
                        <Image src={'/connect/steps/step5.png'} alt='connect' width={550} height={550} priority={true} className='shadow border border-[#ebebeb] w-full h-96 object-cover rounded-md' />
                    </div>
                </div>
                ...
                <div className='md:w-10/12 w-11/12 h-auto flex md:flex-row-reverse flex-col items-center justify-center gap-16'>
                    ...
                    <div className='md:w-1/2 w-full h-auto flex items-center justify-center'>
                        <Image src={'/connect/steps/step6.png'} alt='connect' width={550} height={550} priority={true} className='shadow border border-[#ebebeb] w-full h-96 object-cover rounded-md' />
                    </div>
                </div>

    ...
    return (
        <div className='flex w-full h-auto items-center justify-center bg-[#eaeaea] py-20'>
            <div className='md:w-10/12 w-11/12 h-auto flex flex-col items-center justify-center gap-8'>
                ...
                <div className="relative flex flex-row flex-wrap items-start justify-between text-left pb-6">
                    {homeFaqs.slice(0, 10)?.map((item: any, index: any) => (
                        <div
                            className="md:w-[49%] w-full rounded-xl py-3 md:px-6 px-4 my-3 cursor-pointer bg-white shadow"
                            key={index}

    ...
    return (
        <div className='w-full h-auto flex items-center justify-center relative'>
            ...
            <div className='absolute flex flex-col gap-2 items-center justify-center text-black text-center'>
                <h1 className='md:text-4xl text-3xl font-bold text-[#353535]'>Success Stories</h1>
                <div className='text-lg font-medium'>Celebrate the achievements of our alumni and their journey beyond Vaishali Central School.</div>
            </div>
        </div>
    )
}
